<?php
    ...
    {
            $sql = $basesql . " where 1 order by dia";
    }
    else if($tipo == "consultaxdia")
    {
        $sql = $basesql . " where dia ='" . $dia . "' order by dia asc";
    }
    else if($tipo == "consultaxdiayactividad")
    {
        $sql = $basesql . " where dia ='" . $dia . "' and ". $tablaactividades .".idactividad = " . $idactividad ." order by dia asc";
    }
    else{
        $sql = $basesql . " where idturno =" . $id . " order by dia asc";
    }
