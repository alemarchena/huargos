<?php
    ...
    else if($tipo == "consultaxfechas")
    {
        ...
        . $tablaalumnos.".email,". $tablaalumnos.".nombre,". $tablaalumnos.".apellido from ((( " .$tabla. " LEFT JOIN " 
    ...
    else if($tipo == "consultaxfechayturno")
    {
        ...
        . $tablaalumnos.".email,". $tablaalumnos.".usuario,". $tablaalumnos. ".foto,". $tablaalumnos.".nombre,". $tablaalumnos.".apellido from ( " .$tabla. " LEFT JOIN " 
        . $tablaalumnos. " ON " .$tabla. ".idalumno = ".$tablaalumnos. ".idalumno )";
