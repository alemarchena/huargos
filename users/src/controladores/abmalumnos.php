<?php
    ...
    if($tipo == "guardar"){
        ...
        if($foto=="" && $certificado=="")
            $sql = $basesql . " set fechanacimiento='$fechanacimiento', usuario='$usuario', nombre='$nombre',apellido='$apellido',dni='$dni',email='$email',whatsapp='$whatsapp',estado=$estado where idalumno =$idalumno";

        if($foto!="" && $certificado!="")
            $sql = $basesql . " set fechanacimiento='$fechanacimiento',usuario='$usuario',nombre='$nombre',apellido='$apellido',dni='$dni',email='$email',whatsapp='$whatsapp',foto='$foto',certificado='$certificado',estado=$estado where idalumno =$idalumno";

        if($foto!="" && $certificado=="")
            $sql = $basesql . " set fechanacimiento='$fechanacimiento',usuario='$usuario',nombre='$nombre',apellido='$apellido',dni='$dni',email='$email',whatsapp='$whatsapp',foto='$foto',estado=$estado where idalumno =$idalumno";

        if($foto=="" && $certificado!="")
            $sql = $basesql . " set fechanacimiento='$fechanacimiento',usuario='$usuario',nombre='$nombre',apellido='$apellido',dni='$dni',email='$email',whatsapp='$whatsapp',certificado='$certificado',estado=$estado where idalumno =$idalumno";
